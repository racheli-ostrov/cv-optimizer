...
//     // NEW: service returns the PDF buffer directly
//     const improvedPDF = await optimizeCVService(base64CV, jobDescription);
...
//     // Save improved PDF
//     fs.writeFileSync(outputPath, improvedPDF);

//     // Delete uploaded temp file
//     fs.unlinkSync(req.file.path);

//     // Return ONLY filename (no analysis)
